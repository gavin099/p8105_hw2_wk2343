...
record from n = 285 dumpsters. Among these observations, the average
weight of waste was 3.28 tons, with median at 3.33 tons. Maximum weight
record happened in 2015-05-17, which recorded a historical 5.62 tons of
waste. In volume scale, the average volume of waste was 15.58 qubic
yrads, with median at 15 qubic yards. Maximum volume record happened in
2014-08-13, which recorded a historical 20 quibic yards of waste. During
the data collection period, Mr. Trash Wheel has contributed in total
934.94 tons, 4439 qubic yards of waste, and powered 11950 families.
Thanks Mr. Trash Wheel\!
...
n = 19 months of data. Among these observations, the mean sediment depth
was 2.97 inches, with median at 2.34 inches. Total amount of collected
sediment depth during this period was 56.43 inches. Maximum amount of
sediment was recorded on May, 2018 with 9.27 inches of precipitation.
Specific to precipitation in 2018, the total sediments was 23.5 inches.
...
WHAT IS SNP??? First dataset `pols` contains political data at that
time: the party of current President (`president`), respective numbers
of Governors(`gov_gop, gov_dem`), Senators(`sen_gop, sen_dem`), and
...
time. The merged dataset contains 822 months of data with 11 variables
recorded. Years ranged from 1947, Jan to 2015, Dec. The NA status in
snp\_close and unemployment\_rate is owing to the original data
