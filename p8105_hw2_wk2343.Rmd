...
Grand_join =   
  left_join(Pols_snp_join, Unemployment_data, by = c("year","month")) 
```
...
The merged dataset contains `r dim(Grand_join)[1]` months of data with `r dim(Grand_join)[2]` variables recorded. Years ranged from Jan,1947 to Dec, 2015. The NA status in `snp_close` and `unemployment_rate` is owing to the original data collection period. While snp data started from 1950, unemployment rate record started from 1948. 
